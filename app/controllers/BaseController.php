...
class BaseController
{
    ...
    protected function loadBaseCss()
    {
        ...
        $this->loadJs("vendor/datatables_plugins/integration/bootstrap/3/dataTables.bootstrap.css");
        $this->loadCss('vendor/sweetalert/lib/sweet-alert.css');
        $this->loadCss('vendor/bootstrap-datepicker-master/dist/css/bootstrap-datepicker3.min.css');
    ...
    protected function loadBaseJs()
    {
        ...
        $this->loadJs("vendor/datatables/media/js/jquery.dataTables.min.js");
        $this->loadJs("vendor/datatables_plugins/integration/bootstrap/3/dataTables.bootstrap.min.js");
        $this->loadJs('vendor/sweetalert/lib/sweet-alert.min.js');
        $this->loadJs("vendor/bootstrap-datepicker-master/dist/js/bootstrap-datepicker.min.js");
    ...
    protected function baseUrl()
    {
        ...
        $path       = trim($path, '/');
        $baseUrl    = $this->app->request->getUri();
